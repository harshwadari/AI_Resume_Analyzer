 ...
 *
 * Uses Gmail SMTP by default. For production, consider:
 *   - SendGrid, Mailgun, or Amazon SES for higher deliverability
...
async function sendContactEmail(senderName, senderEmail, message) {
    const mailOptions = {
        ...
        to: process.env.EMAIL_USER, // Sends it to the owner themselves
        replyTo: senderEmail,      // Allows owner to reply directly to the sender
